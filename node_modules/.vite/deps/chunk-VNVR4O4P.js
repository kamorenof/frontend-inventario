...
var DropdownItem = React2.memo(function(props) {
  ...
  return React2.createElement("li", _extends2({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React2.createElement("span", itemGroupLabelProps, content), React2.createElement(Ripple, null));
});
...
var Dropdown = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React2.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React2.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
...
//# sourceMappingURL=chunk-VNVR4O4P.js.map
